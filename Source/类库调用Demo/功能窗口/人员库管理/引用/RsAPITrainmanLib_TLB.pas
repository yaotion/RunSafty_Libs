...
// PASTLWTR : 1.2
// File generated on 2016-11-14 16:13:44 from Type Library described below.
...
const
  ...
  IID_IRsUITrainman: TGUID = '{B03B05D9-7C98-40AF-B8E2-4A65815F9B6D}';
  CLASS_RsUITrainman: TGUID = '{DE4AC052-2C1C-418D-A495-127063FE3B1C}';
...
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {B03B05D9-7C98-40AF-B8E2-4A65815F9B6D}
// *********************************************************************//
  IRsUITrainman = interface(IDispatch)
    ['{B03B05D9-7C98-40AF-B8E2-4A65815F9B6D}']
    function InputTrainman(const WorkShopGUID: WideString; out Trainman: IRsTrainman): WordBool; safecall;
    function Get_APITrainman: IRsAPITrainman; safecall;
    procedure Set_APITrainman(const Value: IRsAPITrainman); safecall;
    function IDTrainman(const TrainmanGUID1: WideString; const TrainmanGUID2: WideString; 
                        const TrainmanGUID3: WideString; const TrainmanGUDI4: WideString; 
                        const DefaultNumber: WideString; out Trainman: IRsTrainman; 
                        out Verify: Integer): WordBool; safecall;
    function Get_CacheTrainmans: IRsTrainmanArray; safecall;
    procedure Set_CacheTrainmans(const Value: IRsTrainmanArray); safecall;
    function Get_CacheVerify: WordBool; safecall;
    procedure Set_CacheVerify(Value: WordBool); safecall;
    function Get_FingerUtils: IDispatch; safecall;
    procedure Set_FingerUtils(const Value: IDispatch); safecall;
    property APITrainman: IRsAPITrainman read Get_APITrainman write Set_APITrainman;
    property CacheTrainmans: IRsTrainmanArray read Get_CacheTrainmans write Set_CacheTrainmans;
    property CacheVerify: WordBool read Get_CacheVerify write Set_CacheVerify;
    property FingerUtils: IDispatch read Get_FingerUtils write Set_FingerUtils;
  end;
...
// *********************************************************************//
  IRsUITrainmanDisp = dispinterface
    ['{B03B05D9-7C98-40AF-B8E2-4A65815F9B6D}']
    function InputTrainman(const WorkShopGUID: WideString; out Trainman: IRsTrainman): WordBool; dispid 201;
    property APITrainman: IRsAPITrainman dispid 202;
    function IDTrainman(const TrainmanGUID1: WideString; const TrainmanGUID2: WideString; 
                        const TrainmanGUID3: WideString; const TrainmanGUDI4: WideString; 
                        const DefaultNumber: WideString; out Trainman: IRsTrainman; 
                        out Verify: Integer): WordBool; dispid 203;
    property CacheTrainmans: IRsTrainmanArray dispid 204;
    property CacheVerify: WordBool dispid 205;
    property FingerUtils: IDispatch dispid 206;
  end;
