...
// PASTLWTR : 1.2
// File generated on 2016-06-28 14:43:50 from Type Library described below.

// ************************************************************************  //
// Type Lib: E:\机务运用安全管理系统\02_开发\01_源代码\基线源码\客户端通用动态库\测酒COM模块\RsAlcoholLib.tlb (1)
...
const
  ...
  IID_TPositionOp: TGUID = '{F05C5F4B-823F-4B7C-9A9C-3C71FB98C505}';
type
...
// *********************************************************************//
  ...
  TPositionOp = interface;
  TPositionOpDisp = dispinterface;
...
// *********************************************************************//
// Interface: TPositionOp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {F05C5F4B-823F-4B7C-9A9C-3C71FB98C505}
// *********************************************************************//
  TPositionOp = interface(IDispatch)
    ['{F05C5F4B-823F-4B7C-9A9C-3C71FB98C505}']
  end;

// *********************************************************************//
// DispIntf:  TPositionOpDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {F05C5F4B-823F-4B7C-9A9C-3C71FB98C505}
// *********************************************************************//
  TPositionOpDisp = dispinterface
